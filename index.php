...
$viewtype = optional_param('viewtype', 'grid', PARAM_ALPHA);
...
$modus = optional_param('modus', 'normal', PARAM_TEXT);

$catalog = new \local_envasyllabus\output\catalog(language_switcher::get_current_langcode(), $viewtype, $modus);
